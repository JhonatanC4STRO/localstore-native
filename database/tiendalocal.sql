...
CREATE TABLE `activity_log` (
  ...
  CONSTRAINT `fk_alog_admin` FOREIGN KEY (`admin_id`) REFERENCES `users` (`id`) ON DELETE SET NULL
...
INSERT INTO `activity_log` VALUES (1,14,'Usuario #13 → estado: suspended','2026-04-19 03:03:51'),(2,14,'Usuario #13 → estado: active','2026-04-19 03:03:51'),(3,14,'Admin creado: pruebax2@test.com (#16), rol: admin','2026-04-19 03:03:51'),(4,NULL,'Usuario #14 → estado: suspended','2026-04-19 03:06:12'),(5,NULL,'Usuario #14 → estado: active','2026-04-19 03:06:18'),(6,NULL,'Admin creado: pepeadmin@gmail.com (#17), rol: admin','2026-04-19 03:08:22'),(7,NULL,'Usuario #12 eliminado (soft delete)','2026-04-19 03:08:56'),(8,17,'Producto #12 → admin_status: deleted','2026-04-20 23:35:59'),(9,17,'Usuario #9 → estado: suspended','2026-04-21 00:03:28'),(10,NULL,'Usuario #9 → estado: active','2026-04-21 00:05:01'),(11,NULL,'Producto #12 → admin_status: deleted','2026-04-21 00:06:22'),(12,NULL,'Producto #12 → admin_status: deleted','2026-04-21 00:06:39'),(13,NULL,'Producto #12 → admin_status: deleted','2026-04-21 00:09:59');
...
INSERT INTO `conversations` VALUES (1,9,2,9,'2026-03-22 00:46:58',1,0),(2,9,9,9,'2026-03-22 00:49:19',1,0),(4,6,2,2,'2026-03-22 01:04:40',1,0),(11,11,6,2,'2026-03-22 02:34:29',0,1),(12,5,2,6,'2026-03-22 02:43:25',1,0),(13,NULL,2,9,'2026-03-24 18:24:36',1,0),(14,NULL,2,9,'2026-03-24 18:36:09',1,0),(15,10,2,9,'2026-03-28 02:52:59',1,0),(16,NULL,2,6,'2026-03-28 07:33:00',1,0),(18,7,11,2,'2026-04-09 14:20:08',0,1),(19,13,2,10,'2026-04-10 20:33:47',1,0),(20,NULL,10,2,'2026-04-13 01:23:03',0,1),(21,NULL,12,2,'2026-04-13 01:31:14',0,1),(22,7,12,2,'2026-04-13 01:33:06',0,1),(23,NULL,13,2,'2026-04-13 01:43:03',0,1),(24,4,13,2,'2026-04-13 01:56:41',0,1),(25,NULL,2,10,'2026-04-13 11:09:53',1,0),(26,NULL,3,2,'2026-04-15 18:30:02',0,1),(27,16,NULL,3,'2026-04-18 22:04:09',0,0),(28,14,2,10,'2026-04-21 01:05:56',0,0),(29,11,20,2,'2026-04-21 18:47:20',0,0),(30,16,20,3,'2026-04-21 18:58:22',0,0);
...
INSERT INTO `product_promotions` VALUES (1,11,'recommended',5000.00,'2026-04-07 01:33:38','2026-04-14 01:33:38','expired','2026-04-07 01:33:38'),(2,8,'basic',3000.00,'2026-04-07 01:52:11','2026-04-10 01:52:11','expired','2026-04-07 01:52:11'),(3,7,'premium',10000.00,'2026-04-07 02:05:52','2026-04-14 02:05:52','expired','2026-04-07 02:05:52'),(4,4,'premium',10000.00,'2026-04-07 02:08:20','2026-04-14 02:08:20','expired','2026-04-07 02:08:20'),(5,11,'premium',10000.00,'2026-04-14 20:31:07','2026-04-21 20:31:07','expired','2026-04-14 20:31:07'),(6,14,'premium',10000.00,'2026-04-14 20:37:47','2026-04-21 20:37:47','expired','2026-04-14 20:37:47'),(7,16,'basic',3000.00,'2026-04-15 19:26:46','2026-04-18 19:26:46','expired','2026-04-15 19:26:46'),(8,19,'premium',10000.00,'2026-04-21 18:56:42','2026-04-28 18:56:42','active','2026-04-21 18:56:42');
...
CREATE TABLE `product_reports` (
  ...
  KEY `fk_preport_reviewer` (`reviewed_by`),
  CONSTRAINT `fk_preport_product` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_preport_reporter` FOREIGN KEY (`reporter_id`) REFERENCES `users` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_preport_reviewer` FOREIGN KEY (`reviewed_by`) REFERENCES `users` (`id`) ON DELETE SET NULL
...
INSERT INTO `product_reports` VALUES (2,11,20,'fraude','bruto no me regalo la moto','rep_1776797410_5b72761b.jpg','resolved','NEgativo',18,'2026-04-21 18:51:40','2026-04-21 18:50:10');
...
INSERT INTO `products` VALUES (4,'aaaaaaa',40000.00,'kkkkkkkkkkkkkkkkkkkkkkkkk',18,'disponible',-75.6133199,1.6168395,'nuevo',2,'2026-03-19 22:01:11','active','2026-04-07 02:08:20',3),(5,'Ropa de segunda',1.00,'Ropa',1,'disponible',-75.6133041,1.6167761,'nuevo',6,'2026-03-19 22:01:11','active',NULL,0),(6,'Jorge ek vendedor',1.00,'ok',2,'disponible',NULL,NULL,'nuevo',2,'2026-03-19 22:01:11','active','2026-04-21 05:50:26',0),(7,'Reloj melo melo',50000.00,'Bonito reloj de segunda mano',8,'disponible',-75.6132991,1.6167661,'nuevo',2,'2026-03-19 22:01:11','active','2026-04-07 02:05:52',3),(8,'Habitacion',55000.00,'fcytgvuhbijhbjkbjlhb',3,'disponible',-75.6133045,1.6167666,'nuevo',2,'2026-03-19 22:01:11','active','2026-04-21 00:43:22',1),(9,'Perfume',67000.00,'Alguna descripcion',11,'disponible',-75.5827963,1.6035703,'nuevo',9,'2026-03-19 22:01:11','active',NULL,0),(10,'Banano',200.00,'Fesco y bonito',13,'disponible',-75.5826936,1.6036405,'nuevo',9,'2026-03-19 22:01:11','active','2026-04-14 20:49:34',0),(11,'Yamaha XTZ 150 – Potencia, estilo y aventura gg papa',13000002.00,'Se vende Yamaha XTZ 150, una moto versátil y confiable, perfecta tanto para la ciudad como para caminos destapados. Su diseño robusto y deportivo la convierte en la opción ideal para quienes buscan rendimiento, comodidad y estilo en un solo vehículo.\r\n\r\n🔹 Motor 150cc eficiente y potente\r\n🔹 Diseño doble propósito (on-road / off-road)\r\n🔹 Suspensión alta ideal para terrenos irregulares\r\n🔹 Excelente rendimiento de combustible\r\n🔹 Frenos de alta seguridad\r\n🔹 Marca reconocida: Yamaha\r\n\r\n💥 Perfecta para trabajo, viajes o uso diario.\r\n💥 Bajo consumo y mantenimiento económico.\r\n\r\n📍 Lista para traspaso inmediato\r\n📞 Contáctame para más información o verla en persona',22,'disponible',-75.5828083,1.6035726,'nuevo',2,'2026-03-19 22:01:11','active','2026-04-14 20:31:07',3),(13,'Zapatos para bebé',80000.00,'👶💖 ¡Los más pequeños también merecen estilo!\r\n\r\nEstos zapatitos para bebé son tan adorables como cómodos. Perfectos para acompañar sus primeros pasos. 🥰\r\n\r\n✔️ Suaves y seguros\r\n✔️ Diseño adorable\r\n✔️ Máxima comodidad\r\n\r\n✨ ¡Haz que cada paso sea especial!\r\n',10,'disponible',-75.5826990,1.6036363,'usado',10,'2026-04-10 20:27:54','active',NULL,0),(14,'Hoodie azul',120000.00,'💙 Comodidad + estilo en una sola prenda 💙\r\n\r\nEste hoodie azul es perfecto para tu día a día. Ya sea para salir o relajarte, siempre vas a verte bien. 😎\r\n\r\n✔️ Suave y cómodo\r\n✔️ Diseño moderno\r\n✔️ Ideal para cualquier clima\r\n\r\n🔥 ¡No te quedes sin el tuyo!\r\n',9,'disponible',-75.5827328,1.6036243,'usado',10,'2026-04-10 20:37:52','active','2026-04-21 05:39:11',3),(15,'Sombrero elegante',450000.00,'✨ Dale un toque de elegancia a tu estilo ✨\r\n\r\nEste sombrero es el complemento perfecto para cualquier outfit. Ideal para un look casual o algo más sofisticado. 🤎\r\n\r\n✔️ Diseño clásico\r\n✔️ Cómodo y ligero\r\n✔️ Perfecto para cualquier ocasión\r\n\r\n🔥 ¡Hazlo parte de tu estilo hoy!\r\n',9,'disponible',-75.5826868,1.6036501,'nuevo',10,'2026-04-10 20:38:39','active',NULL,0),(16,'Zapatos nikes',155000.00,'Zapatos nike nuevos ubicados en florencia caquetas',10,'disponible',-75.6116160,1.6101255,'nuevo',3,'2026-04-15 19:00:20','active','2026-04-15 19:29:39',1),(18,'Anillo',1200000.00,'Anillo de oro y diamantes',5,'disponible',-75.6133072,1.6167941,'usado',18,'2026-04-21 00:32:18','active',NULL,0),(19,'Zapatos de jardinero botanico',1200000.00,'Usados con 2 posturas',16,'disponible',-74.0577500,4.6652875,'usado',20,'2026-04-21 18:54:22','active','2026-04-21 18:56:42',3),(20,'Falda gotica para qlona Fabiana',1200000.00,'',9,'disponible',-110.2052592,53.8939835,'reacondicionado',20,'2026-04-21 18:55:19','active',NULL,0);
...
INSERT INTO `reviews` VALUES (1,9,2,3,'el produfotjorjpor','2026-03-28 07:15:25'),(3,13,2,5,'Exelente','2026-04-13 11:39:10'),(4,19,18,5,'','2026-04-21 19:00:33');
...
CREATE TABLE `seller_verifications` (
  ...
  KEY `idx_user` (`user_id`),
  KEY `idx_status` (`status`),
  KEY `fk_sv_reviewer` (`reviewed_by`),
...
INSERT INTO `seller_verifications` VALUES (5,3,'persona','Maria Lopez','','Florencia','3214567788','Cédula de ciudadanía','public/uploads/verificaciones/verif_3_1776282452.pdf','Porque si','approved',NULL,NULL,'2026-04-15 19:55:27','2026-04-15 19:47:32','2026-04-21 05:50:26'),(7,2,'negocio','ShopShon','Ropa y moda','Florencia','3144788677','Cámara de Comercio','public/uploads/verificaciones/verif_2_1776469709.pdf','Vendo ropa de primera mano y original','rejected','Los datos no coinciden con el registro.',NULL,'2026-04-17 23:49:23','2026-04-17 23:48:29','2026-04-21 05:50:26');
...
CREATE TABLE `user_reports` (
  ...
  KEY `idx_reporter` (`reporter_id`),
  KEY `idx_status` (`status`),
  KEY `fk_ureport_reviewer` (`reviewed_by`),
  CONSTRAINT `fk_ureport_reporter` FOREIGN KEY (`reporter_id`) REFERENCES `users` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_ureport_reviewer` FOREIGN KEY (`reviewed_by`) REFERENCES `users` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_ureport_target` FOREIGN KEY (`reported_user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
...
CREATE TABLE `user_settings` (
  ...
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`user_id`),
  KEY `idx_who_can_message` (`privacy_who_can_message`),
...
INSERT INTO `user_settings` VALUES (10,1,1,1,1,1,1,0,'all','2026-04-21 01:05:45'),(20,1,1,1,1,1,1,0,'nobody','2026-04-21 19:00:12');
...
INSERT INTO `users` VALUES (2,'Jhonatan castro calderon','shonano@gmail.com','123','2026-03-17 06:05:26','3144788677','Florencia','Juan xxiii','Esto es un demo gg','u2_1775561589.png','active','seller','2026-04-07 11:33:09',NULL,NULL),(3,'Maria Lopez','maria@gmail.com','123','2026-03-17 12:11:46',NULL,NULL,NULL,NULL,NULL,'active','seller','2026-04-15 19:00:20',NULL,NULL),(4,'El esquinazo','esquinazo@gmail.com','123','2026-03-17 18:05:15',NULL,NULL,NULL,NULL,NULL,'active','user','2026-04-03 04:10:45',NULL,NULL),(6,'FerroMax','ferromax@gmail.com','123','2026-03-17 18:06:54',NULL,NULL,NULL,NULL,NULL,'active','seller','2026-04-03 04:28:46',NULL,NULL),(8,'','','','2026-03-19 02:18:57',NULL,NULL,NULL,NULL,NULL,'active','user','2026-04-03 04:10:45',NULL,NULL),(9,'Claude Lopez','claudia@gmail.com','123','2026-03-19 17:31:46',NULL,NULL,NULL,NULL,NULL,'active','seller','2026-04-21 00:05:01',NULL,NULL),(10,'Topogigio','topo@gmail.com','123','2026-03-19 18:14:05',NULL,NULL,NULL,NULL,NULL,'active','seller','2026-04-10 20:13:14',NULL,NULL),(11,'Gustavo Adolfo','gustavo@gmail.com','123','2026-03-19 20:49:06',NULL,NULL,NULL,NULL,NULL,'active','user','2026-04-03 04:10:45',NULL,NULL),(12,'Test User','testuser@example.com','Password123!','2026-04-13 01:30:54',NULL,NULL,NULL,NULL,NULL,'blocked','user','2026-04-19 03:08:56','2026-04-19 03:08:56',NULL),(13,'Tester User','tester@example.com','password123','2026-04-13 01:42:50',NULL,NULL,NULL,NULL,NULL,'active','seller','2026-04-19 03:03:51',NULL,NULL),(14,'Prueba admin','admin2@gmail.com','$2y$10$Jp0qoCe3h.dVHLyEkTYH0ON57cFSBrO4nN1WOIwHlZ8hHwtrNulri','2026-04-19 02:58:57',NULL,NULL,NULL,NULL,NULL,'active','admin','2026-04-19 03:06:18',NULL,NULL),(17,'Pepe admin','pepeadmin@gmail.com','$2y$10$.pTYs/lKGpgSh8cLc/DnLuufp7xNUDL1486zJBT.Xpg12JL3fQW0e','2026-04-19 03:08:22',NULL,NULL,NULL,NULL,NULL,'active','admin','2026-04-19 03:08:22',NULL,NULL),(18,'Administrador','admin@gmail.com','$2y$10$f/pGYVtDuNdRFjZkOGkbgum56m1UeA9MuLwLCHaz9ocaiwT5Q2VE6','2026-04-21 00:19:05',NULL,NULL,NULL,NULL,NULL,'active','admin','2026-04-21 00:19:05',NULL,NULL),(20,'Monica Galindo','monicaga@gmail.com','123','2026-04-21 18:47:09',NULL,NULL,NULL,NULL,NULL,'active','seller','2026-04-21 18:54:22',NULL,NULL);
...
-- Dump completed on 2026-04-21 22:15:57
