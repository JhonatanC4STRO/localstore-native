...
<div class="page-shell">
  ...
  <aside class="sidebar">
    ...
    <a class="sb-link active" href="./promociones.php"><i class="bi bi-rocket-takeoff-fill"></i> Promociones</a>
    ...
    <div class="sb-promo">
      ...
      <p>Llega a 10× más compradores con un plan de promoción.</p>
          ...
          <?php else: ?>
            <?php foreach ($userProducts as $up): ?>
              <div class="selector-card">
                <div class="sc-img">
                  <?php if ($up['image_url']): ?>
                    <img src="./productos/uploads/<?= htmlspecialchars($up['image_url']) ?>" alt="">
                  <?php else: ?>
                    <span>📦</span>
                  <?php endif; ?>
                </div>
                <div class="sc-body">
                  ...
                  <div class="sc-price">$<?= number_format((float)$up['price'], 0, ',', '.') ?> COP</div>
                ...
                <div class="sc-footer">
                  <?php if ($up['active_plan']): ?>
                    <div class="sc-promo-active">
                      ...
                      Plan <?= ucfirst($up['active_plan']) ?> activo
                    </div>
                  <?php else: ?>
                    <button class="btn-select-product"
                      onclick="location.href='./promociones.php?product_id=<?= $up['id'] ?>'">
                      <i class="bi bi-rocket-takeoff"></i> Promocionar
                    </button>
                  <?php endif; ?>
                </div>
              </div>
      ...
      <div class="wizard-screen" id="screenSuccess">
        <div class="result-screen">
          ...
          <div class="result-actions">
            <a href="./misProductos.php" class="btn-result btn-result-primary">
