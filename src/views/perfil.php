...
if ($r) { $row = mysqli_fetch_assoc($r); $totalProducts = $row['c']; }
...
include __DIR__ . '/../components/header.php'; ?><div class="page-shell">
        ...
        <!-- ══ SIDEBAR ══ -->
        <?php $activeTab = 'perfil'; include __DIR__ . '/../components/sidebar.php'; ?>
                        ...
                        <div class="card avatar-card">
                            <div class="card-body" style="text-align:center;padding:28px 22px;">
                                ...
                                <div class="avatar-wrap">
                                    <div class="avatar-lg">
                                        <?php if (!empty($user['profile_photo'])): ?>
                                            <img src="../../public/uploads/avatars/<?php echo htmlspecialchars($user['profile_photo']); ?>" id="avatarPreview" alt="">
                                        <?php
else: ?>
                                ...
                                <div class="profile-stats">
                                    <div class="ps-item">
                                        <?php /* $totalProducts already computed in header */ ?>
                                        <div class="ps-num"><?php echo $totalProducts; ?></div>
