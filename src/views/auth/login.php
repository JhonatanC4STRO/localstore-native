...
<body>
  ...
  <div class="left-panel">
    ...
    <div class="left-content">
      ...
      <!-- Logo -->
       <a href="../home.php" class=" flex justify-center" ><img class="h-40 w-40" src="../../../public/img/logo.png" alt=""></a>
    ...
    <div class="form-shell">
      ...
      <form action="../../controllers/auth_login.php" method="POST">
        ...
        <?php if (isset($_GET['error'])):
          $err = $_GET['error'];
          $msg = match ($err) {
              'suspended' => 'Tu cuenta está suspendida. Contacta al soporte para más información.',
              'blocked'   => 'Tu cuenta está bloqueada y no tienes acceso a la plataforma.',
              'deleted'   => 'Esta cuenta fue eliminada.',
