...
function renderProductSummary() {
  ...
  if (PRODUCT_IMAGE) {
    imgWrap.innerHTML = `<img src="../../public/uploads/products/${PRODUCT_IMAGE}" alt="">`;
  }
...
async function confirmPayment() {
  ...
  try {
    const res = await fetch('../api/payments/simulate.php', {
      method:  'POST',
